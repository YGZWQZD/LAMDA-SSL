...
from Semi_sklearn.Model.Classifier.S4L import S4L
...
model=S4L(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
               ...
               lambda_u=1.5,train_sampler=train_sampler,valid_sampler=valid_sampler,
