...
model=Mixmatch(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
               ...
               train_batch_sampler=train_batchsampler,ema_decay=0.999,warmup=1 / 64,T=0.5,alpha=0.5)
