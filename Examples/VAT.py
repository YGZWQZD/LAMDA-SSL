...
from Semi_sklearn.Alogrithm.Classifier.VAT import VAT
...
model=VAT(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
               ...
               eval_it=2000,mu=1,evaluation=evaluation,
               lambda_u=0.3,train_sampler=train_sampler,valid_sampler=valid_sampler,test_sampler=test_sampler,
               train_batch_sampler=train_batchsampler,ema_decay=0.999,
               weight_decay=5e-4,eps=6,xi=1e-6,it_vat=1,warmup=0.4,lambda_entmin=0.06)
