...
from Semi_sklearn.Alogrithm.Regressor.PiModel import PiModelRegressor
...
f = open("../Result/PiModel_Reg.txt", "w")
# dataset
...
model=PiModelRegressor(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
