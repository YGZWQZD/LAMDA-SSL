...
from lamda_ssl.Algorithm.Classifier.Mixmatch import Mixmatch
from lamda_ssl.Algorithm.Classifier.ICT import ICT
...
model=ICT(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
               ...
               lambda_u=100,train_sampler=train_sampler,valid_sampler=valid_sampler,test_sampler=test_sampler,
               train_batch_sampler=train_batchsampler,ema_decay=0.999,warmup=1 / 64,alpha=0.5)
