...
from Semi_sklearn.Algorithm.Classifier.Fully import Fully
...
model=Fully(train_dataset=train_dataset,valid_dataset=valid_dataset,test_dataset=test_dataset,
               ...
               train_batch_sampler=train_batchsampler,ema_decay=0.999,threshold=0.8,T=0.4,weight_decay=5e-4,lambda_u=1.0)
