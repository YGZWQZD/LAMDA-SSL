...
3) It should have a large number of algorithms with rich types and good performance for users to choose according to application scenarios. It should have both statistical machine learning algorithms and deep learning algorithms;
